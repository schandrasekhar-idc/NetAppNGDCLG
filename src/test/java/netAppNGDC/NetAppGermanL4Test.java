...
public class NetAppGermanL4Test 
{
		...
		public static void assessment() throws InterruptedException//main(String[] args) throws InterruptedException
		{
			...
			//click 2nd option for "Warum beschäftigen Sie sich mit Infrastrukturlösungen für agile Rechenzentren? Was ist der Hauptgrund?"
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm1\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			*/	//K”)).isDisplayed();
			...
			//click option 2: Kontinuierlich
			Thread.sleep(2000);
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm3\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm4\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm5\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm7\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Action action = move.dragAndDropBy(slider, 850, 0).build();
			action.perform();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm9\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm10\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm11\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Organization.click();
			Organization.sendKeys("IDC Test SC - Transformer");
			
			//Unternehmensstandort
			CompanyLocation.click();
			CompanyLocation.sendKeys("Canada");
			
			//Branche
			Select IndustryClick = new Select(Industry);
			IndustryClick.selectByValue("79");
			
			//Unternehmensgröße
			Select EmployeeSizeClick = new Select(EmployeeSize);
			EmployeeSizeClick.selectByValue("105");
			...
			//Jobtitle
			NetAppG.findElement(By.xpath("//*[@id=\"Q19-QI20-AC111\"]")).sendKeys("CFO");
