...
public class NetAppGermanL1Test 
{
		...
		public static void assessment() throws InterruptedException//main(String[] args) throws InterruptedException
		{
			...
			//click 5th option for "Warum beschäftigen Sie sich mit Infrastrukturlösungen für agile Rechenzentren? Was ist der Hauptgrund?"
			...
			Thread.sleep(2000);
			//click 3rd option for  "Wie ist Ihre IT-Organisation strukturiert?
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm2\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			*/	//K”)).isDisplayed();
			...
			//click option 5:
			Thread.sleep(2000);
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm3\"]/div/section/fieldset/section/div[2]/div/section/label[5]")).click();
			...
			Thread.sleep(2000);
			//click option 5:
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm4\"]/div/section/fieldset/section/div[2]/div/section/label[5]")).click();
			...
			Thread.sleep(2000);
			//click option 5:
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm5\"]/div/section/fieldset/section/div[2]/div/section/label[5]")).click();
			...
			Thread.sleep(2000);
			//click option 3
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm6\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Thread.sleep(2000);
			//click option 5
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm7\"]/div/section/fieldset/section/div[2]/div/section/label[5]")).click();
			...
			Thread.sleep(2000);
			//click option 5
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm9\"]/div/section/fieldset/section/div[2]/div/section/label[5]")).click();
			...
			Thread.sleep(2000);
			//click option 5
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm10\"]/div/section/fieldset/section/div[2]/div/section/label[5]")).click();
			...
			Thread.sleep(2000);
			//click option 5
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm11\"]/div/section/fieldset/section/div[2]/div/section/label[5]")).click();
			...
			Organization.click();
			Organization.sendKeys("IDC Test SC - Nachzügler");
			
			//Unternehmensstandort
			CompanyLocation.click();
			CompanyLocation.sendKeys("UK");
			
			//Branche
			Select IndustryClick = new Select(Industry);
			IndustryClick.selectByValue("94");
			
			//Unternehmensgröße
			Select EmployeeSizeClick = new Select(EmployeeSize);
			EmployeeSizeClick.selectByValue("101");
			...
			//Jobtitle
			NetAppG.findElement(By.xpath("//*[@id=\"Q19-QI20-AC111\"]")).sendKeys("QA");
