...
public class NetAppGermanL2Test 
{
		...
		public static void assessment() throws InterruptedException//main(String[] args) throws InterruptedException
		{
			...
			//click 4th option for "Warum beschäftigen Sie sich mit Infrastrukturlösungen für agile Rechenzentren? Was ist der Hauptgrund?"
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm1\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			
			NetAppG.findElement(By.xpath("//*[@id=\"btnNext\"]")).click();
			
			Thread.sleep(2000);
			//click 2nd option for  "Wie ist Ihre IT-Organisation strukturiert?
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm2\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			*/	//K”)).isDisplayed();
			...
			//click option 4:
			Thread.sleep(2000);
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm3\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			...
			Thread.sleep(2000);
			//click option 4
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm4\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			...
			Thread.sleep(2000);
			//click option 4
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm5\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm6\"]/div/section/fieldset/section/div[2]/div/section/label[2]")).click();
			...
			Thread.sleep(2000);
			//click option 4
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm7\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			...
			Action action = move.dragAndDropBy(slider, 500, 0).build();
			action.perform();
			...
			Thread.sleep(2000);
			//click option 4
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm9\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			...
			Thread.sleep(2000);
			//click option 4
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm10\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			...
			Thread.sleep(2000);
			//click option 4
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm11\"]/div/section/fieldset/section/div[2]/div/section/label[4]")).click();
			...
			Organization.click();
			Organization.sendKeys("IDC Test SC - Pragmatiker");
			
			//Unternehmensstandort
			CompanyLocation.click();
			CompanyLocation.sendKeys("India");
			
			//Branche
			Select IndustryClick = new Select(Industry);
			IndustryClick.selectByValue("83");
			
			//Unternehmensgröße
			Select EmployeeSizeClick = new Select(EmployeeSize);
			EmployeeSizeClick.selectByValue("103");
			
			//Anrede
			Select AnredeClick = new Select(Anrede);
			AnredeClick.selectByValue("108");
			...
			//Jobtitle
			NetAppG.findElement(By.xpath("//*[@id=\"Q19-QI20-AC111\"]")).sendKeys("IT");
