...
public class NetAppGermanL3Test 
{
		...
		public static void assessment() throws InterruptedException//main(String[] args) throws InterruptedException
		{
			...
			//click 3rd option for "Warum beschäftigen Sie sich mit Infrastrukturlösungen für agile Rechenzentren? Was ist der Hauptgrund?"
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm1\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			*/	//K”)).isDisplayed();
			...
			//click option 3: Kontinuierlich
			Thread.sleep(2000);
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm3\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Thread.sleep(2000);
			//click option 3
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm4\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Thread.sleep(2000);
			//click option 3
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm5\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Thread.sleep(2000);
			//click option 2
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm7\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Action action = move.dragAndDropBy(slider, 700, 0).build();
			action.perform();
			...
			Thread.sleep(2000);
			//click option 3
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm9\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Thread.sleep(2000);
			//click option 3
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm10\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Thread.sleep(2000);
			//click option 3
			NetAppG.findElement(By.xpath("//*[@id=\"sectionForm11\"]/div/section/fieldset/section/div[2]/div/section/label[3]")).click();
			...
			Organization.click();
			Organization.sendKeys("IDC Test SC - Player");
			
			//Unternehmensstandort
			CompanyLocation.click();
			CompanyLocation.sendKeys("China");
			
			//Branche
			Select IndustryClick = new Select(Industry);
			IndustryClick.selectByValue("82");
			
			//Unternehmensgröße
			Select EmployeeSizeClick = new Select(EmployeeSize);
			EmployeeSizeClick.selectByValue("104");
			...
			//Jobtitle
			NetAppG.findElement(By.xpath("//*[@id=\"Q19-QI20-AC111\"]")).sendKeys("VP");
